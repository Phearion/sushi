...
export const getFiles = async (prediction: string): Promise<{name: string, data: string}[] | string> => {
    ...
    const dirPath = path.join(__dirname, '..', '..', 'assets', 'aero1Sources', subject, 'fiche', topic);
    console.log(dirPath)
